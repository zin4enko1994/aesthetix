<?php
/*
Template Name: Template Micropigmentation Brows
...
<section class="block-wrapper">
	...
	<div class="third" style="background-image: url(<?php echo get_field('third_image') ['url'] ?>);">
		<div class="text">
	...
	<div class="fourth">
		<div class="image" style="background-image: url(<?php echo get_field('fourth_image') ['url'] ?>);"></div>
		<div class="text">
			<h2><?php echo $post_field['fourth_title'] ?></h2>
			<p><?php echo $post_field['fourth_text'] ?></p>
		</div>

	</div>
	<div class="fifth" >
		<div class="text">
			<p><?php echo $post_field['fifth_text'] ?></p>
		</div>
		<div class="image" style="background-image: url(<?php echo get_field('fifth_image') ['url'] ?>);"></div>
	</div>
</section>
<section class="related-services">
	...
	<div class="wrapper">
		...
		$args = array(
			'post_type'  => 'post',
			'category_name' => 'facial-and-neck-pigmentation-enhancement-reduction',
			'orderby'  => 'date',
			'order'    => 'DESC',
			'post__not_in' => array(
				$currentID)
