<?php
/*
Template Name: Template Skin Tightening
...
<section class="block-wrapper">
	<div class="first" style="background-image: url(<?php echo get_field('first_image') ['url'] ?>);">
		<div class="first-block">
			<?php echo $post_field['first_block'] ?>
		</div>
		<div class="second-block">
			<?php echo $post_field['second_block'] ?>
		</div>
	</div>
	<div class="second">
		<div class="text"><?php echo $post_field['second_text'] ?></div>
	...
	<div class="third" style="background-image: url(<?php echo get_field('third_background') ['url'] ?>);">
		<div class="text"><?php echo $post_field['third_text'] ?></div>
	</div>
</section>
