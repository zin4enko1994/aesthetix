<?php
/*
Template Name: Template Milla Removal
...
<?php get_header(); ?>
<section class="main">
	<div class="template-title"><span>prevent & remove MILIA</span> <?php the_title(); ?></div>
</section>
...
<section class="block-wrapper">
	...
	<div class="second">
		<div class="text">
			<h2 class="title"><?php echo $post_field['second_title'] ?></h2>
	...
	<div class="fourth">
		...
		<div class="image" style="background-image: url(<?php echo get_field('fourth_background') ['url'] ?>);"></div>
	</div>
</section>
