<?php
/*
Template Name: Template Skin pigmentation
...
<section class="block-wrapper">
    <div class="first" style="background-image: url(<?php echo get_field('first_image') ['url'] ?>);">
		<div class="text">
			<h2><?php echo $post_field['first_title'] ?></h2>
			<p><?php echo $post_field['first_text'] ?></p>
		</div>
	</div>
	<div class="second">
		<div class="text">
	...
	<div class="fourth">
		<div class="item">
			<div class="text"><?php echo $post_field['fourth_text_one'] ?></div>
		...
		<div class="item">
			...
			<div class="text"><?php echo $post_field['fourth_text_two'] ?></div>
		</div>
	</div>
</section>
