<?php
/*
Template Name: Template Hydra facials
...
<section class="block-wrapper">
    <div class="first">
		<div class="text">
			<h2 class="title"><?php echo $post_field['first_title'] ?></h2>
	...
	<div class="second">
		<div class="item">
			<div class="image" style="background-image: url(<?php echo get_field('second_image_one') ['url'] ?>);"></div>
			<div class="text"><?php echo $post_field['second_text_one'] ?></div>
		</div>
		<div class="item">
			<div class="text"><?php echo $post_field['second_text_two'] ?></div>
			<div class="image" style="background-image: url(<?php echo get_field('second_image_two') ['url'] ?>);"></div>
		</div>
	</div>
	<div class="third">
