<?php
/*
Template Name: Template Cryotherapy Facial
...
<section class="block-wrapper">
	<div class="first" >
		...
		<div class="text">
			...
			<h2><?php echo $post_field['first_subtitle'] ?></h2>
			<?php echo $post_field['first_text'] ?>
		</div>
	</div>
	<div class="second" style="background-image: url(<?php echo get_field('second_background') ['url'] ?>);">
		<div class="text">
	...
	<div class="third">
		<div class="item">
			<div class="text"><?php echo $post_field['text_one'] ?></div>
		...
		<div class="item">
			...
			<div class="text"><?php echo $post_field['text_two'] ?></div>
		</div>
	</div>
</section>
