<?php
/*
Template Name: Template Thread vein treatment
...
<section class="block-wrapper">
	<div class="first"
		 style="background-image: url(<?php echo get_field('background_block') ['url'] ?>);">
		<div class="text-block-one">
			<?php echo $post_field['text-block-one'] ?>
		</div>
		<div class="text-block-two">
			<?php echo $post_field['text-block-two'] ?>
		</div>
	</div>
	<div class="second">
		<div class="text">
