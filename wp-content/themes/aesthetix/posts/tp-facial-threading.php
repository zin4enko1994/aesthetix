<?php
/*
Template Name: Template Facial Threading
...
<section class="block-wrapper">
	<div class="first"
		 style="background-image: url(<?php echo get_field('first_background') ['url'] ?>);">
		<div class="text">
	...
	<div class="second">
		...
		<div class="image" style="background-image: url(<?php echo get_field('second_image') ['url'] ?>);">
			<p><?php echo $post_field['second_text'] ?></p>
		</div>
	</div>
	<div class="third">
		<div class="item">
...
<section class="related-services">
	...
	<div class="wrapper">
		...
		$args = array(
			'post_type'  => 'post',
			'category_name' => 'eyebrow-shaping-sculpting-pigmentation',
			'orderby'  => 'date',
			'order'    => 'DESC',
			'post__not_in' => array(
				$currentID)
